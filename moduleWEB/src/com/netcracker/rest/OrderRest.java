...
public class OrderRest {
	...
	@POST
	@javax.ws.rs.Path("createWithoutRegistration") //TODO create new user to every order
	@Consumes("application/json")
	...
	@GET
	@javax.ws.rs.Path("viewOrderByPublicToken")
	public Response viewOrderByPublicToken(@QueryParam("publicToken") String publicToken) {
