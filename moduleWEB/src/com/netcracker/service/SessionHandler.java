...
public class SessionHandler {
     ...
     * @param sessionToken - service token to be checked
    ...
    /**
     * Extends service validity up to 30 minutes
     * @param sessionToken - service to be refreshed
     * @return - result
     */
